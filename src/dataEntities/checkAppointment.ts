...
export function checkAppointment(obj: any, type: ChannelType) {
  ...
  if (obj["type"] !== type)
    throw new PublicDataValidationError(
      `Appointment is of type ${obj["type"]}`
    );
...
export function propertyExistsAndIsOfType(
  property: string,
  basicType: string,
  obj: any
) {
...
export function doesPropertyExist(property: string, obj: any) {
  if (typeof obj[property] === typeof undefined)
    throw new PublicDataValidationError(`${property} not defined.`);
}

export function isPropertyOfType(
  property: string,
  basicType: string,
  obj: any
) {
  if (typeof obj[property] !== basicType) {
    throw new PublicDataValidationError(
      `${property} is of type: ${typeof obj[property]} not ${basicType}.`
    );
  }
}

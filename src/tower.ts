...
export abstract class EthereumAppointmentSigner {
   ...
   * @param appointment
   */
  public abstract signAppointment(
    appointment: EthereumAppointment
  ): Promise<string>;
}

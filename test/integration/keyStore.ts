...
export class Key {
  ...
  constructor(
    public readonly mnemoic: string,
...
export class KeyStore {
  ...
  private mnemonic4 =
    "glow silver hood half strong wait van sorry brain course tower aerobic aerobic vast tattoo";
  private mnemonic5 =
    "truth install memory wish industry border victory gather model abandon device one boss mountain increase";
  private mnemonic6 =
    "merit reunion current elite minor carpet fan lonely glue there property shoe rich loan cheap";
  private mnemonic7 =
    "alpha bonus laundry stay divorce loyal lawn anxiety tobacco relax rail fold rare hen profit";
  private mnemonic8 =
    ...
    this.account0 = new Key(
      ...
      "account0",
      {
        ...
        Crypto: {
          ...
          ciphertext:
            "9de7b8df781c5de6c2e6ea32fb9ec973dfcfa4c9ab1aa1f3c77bbb45fb64879e",
          kdf: "scrypt",
          kdfparams: {
            salt:
              "33489d8614a7b087136c846bfdf54195dabdf906f3fd358bc505ae0b1642d416",
            n: 131072,
            dklen: 32,
            p: 1,
            r: 8,
          ...
          mac:
            "2034b945b91d502e07b66dd89f0f11054916241c8cfb13ee1bb24770890c9bf6",
        },
      }
    );
    this.account1 = new Key(
      ...
      "account1",
      {
        ...
        Crypto: {
          ...
          ciphertext:
            "d500b7d31bf809c6002aa71bd37665f9f0dbea23fbd1a6d82855f485b71e3f78",
          kdf: "scrypt",
          kdfparams: {
            salt:
              "f804485c0648ebee1b7946c624fa2972bb1875dd1931d2a3e1059168a1b9625d",
            n: 131072,
            dklen: 32,
            p: 1,
            r: 8,
          ...
          mac:
            "da134d318f912235a37b116ad2283af5f48500c49e0bdc77f7024341b590a1e4",
        },
      }
    );
  }
